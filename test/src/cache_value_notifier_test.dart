...
void main() async {
  ...
  CacheValueNotifier<T> create<T extends Object>(CacheValueDef<T> def) =>
      CacheValueNotifier(CacheValue(prefs: prefs, def: def));

  setUp(() async {
    await prefs.clear();
    reset(listener);
    cacheValueNotifier = create(CacheValueDef.string(key));
